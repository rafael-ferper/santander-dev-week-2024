const routes = {
  champions: "http://ferper-rafael-champions-lol.sa-east-1.elasticbeanstalk.com/champions",
  ask: "http://ferper-rafael-champions-lol.sa-east-1.elasticbeanstalk.com/champions/{id}/ask"
};
...
async function onChangeChampionSelected(id, imageUrl) {
  window.onload = state.views.avatar.style.backgroundImage = "url('https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Jinx_0.jpg')";
